...
export default function all() {
    ...
    const { data, error, isLoading, mutate } = useSWR('/sponsors/retail', fetcher)

    // console.log(data)
    return (
        <UserLayout
            title='Retail sponsors'
            breads={[
                {
                    title: 'Retail sponsors',
                    link: '/user/personals/retail_sponsor'
                }
            ]}
        >
            <SafeArea>
                <Card>
                    <CardHeader borderBottom={'1px'} borderColor='gray.200'>
                        <Flex alignItems='center' justify='space-between'>
                            <Heading as='h6' fontSize={'lg'}>Retail Sponsors</Heading>
                    ...
                    <CardBody>
                        ...
                        {data?.users?.length ? <TableContainer p={0}>
                            ...
                            : <NoDataFound text='No retail sponsors found!' />}
